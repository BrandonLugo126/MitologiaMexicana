...
public partial class MitologiaMexicanaContext : DbContext
{
    ...
    public virtual DbSet<CivilizacionDio> CivilizacionDios { get; set; }

    public virtual DbSet<Civilizacione> Civilizaciones { get; set; }

    public virtual DbSet<Diose> Dioses { get; set; }

    protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see https://go.microsoft.com/fwlink/?LinkId=723263.
        => optionsBuilder.UseMySql("user=root;password=root;server=localhost;database=mitologia_mexicana;port=3308", Microsoft.EntityFrameworkCore.ServerVersion.Parse("8.0.37-mysql"));
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<CivilizacionDio>(entity =>
        {
        ...
        modelBuilder.Entity<Civilizacione>(entity =>
        {
        ...
        modelBuilder.Entity<Diose>(entity =>
        {
            entity.HasKey(e => e.Id).HasName("PRIMARY");
